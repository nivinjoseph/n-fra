...
export class VpcProvisioner
{
    ...
    private _vpcName: string | null = null;
    private _vpc: aws.ec2.Vpc | null = null;
    private _igw: aws.ec2.InternetGateway | null = null;
    private readonly _subnets = new Array<VpcSubnetDetails>();
    private readonly _ngws = new Map<string, aws.ec2.NatGateway>();
    private _pvtDnsName: string | null = null;
    ...
    private _createSubnet(subnetConfig: VpcSubnetConfig): VpcSubnetDetails
    {
    ...
    private _createNatGateway(subnet: aws.ec2.Subnet, az: VpcAz): void
    {
    ...
    private _createDefaultSecurityGroup(): void
    {
    ...
    private _provisionVpcFlowLogs(vpcName: string): void
    {
    ...
    private _createPrivateDnsNamespace(): void
    {
    ...
    private _createVpcS3GatewayEndpoint(): void
    {
    ...
    // private _getRouteTableIds(): Pulumi.Output<Array<Pulumi.Output<string>>>
    // {
    //     const routeTableIds = this._vpc!.subnets
    //         .apply(result =>
    //         {
    //             const rtIds = result
    //                 .map(t =>
    //                 {
    //                     const routeTable = aws.ec2
    //                         .getRouteTableOutput({
    //                             subnetId: t.id,
    ...
    // private _getRouteTableIds(): Pulumi.Output<Array<Pulumi.Output<string>>>
    // {
    //     const rtIds = this._vpc!.subnets.apply(t =>
    //     {
    //         return t.map(subnet =>
    //         {
