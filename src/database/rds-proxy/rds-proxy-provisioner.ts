...
export class RdsProxyProvisioner
{
    ...
    private readonly _config: RdsProxyConfig;


    public constructor(name: string, config: RdsProxyConfig)
    {
    ...
    public provision(): RdsProxyDetails
    {
        ...
        const egressCidrBlocks = SecurityGroupHelper.resolveCidrBlocks(
            this._config.vpcDetails, [this._config.dbSubnetNamePrefix]);
