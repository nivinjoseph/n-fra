...
export class PostgresInstanceProvisioner
{
    ...
    private readonly _config: PostgresInstanceConfig;


    public constructor(name: string, config: PostgresInstanceConfig)
    {
        ...
        given(config, "config").ensureHasValue().ensureIsObject()
            ...
            .ensureWhen(config.engineVersion != null,
                (t) => [12, 13, 16].contains(t.engineVersion!),
                "engine version must be 12, 13 or 16")
    ...
    public provision(): PostgresInstanceDetails
    {
        ...
        let parameterGroupName: string | Pulumi.Output<string> = "default.postgres12";
